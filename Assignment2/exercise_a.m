...
% Find decision boundary for double cost for misclassifying 'b'
misclassified_double_cost_for_b = misclassified .* repmat([1 2]',1,9)
[min_ index2] = min(sum(misclassified_double_cost_for_b))
index2 = index2 + 1
